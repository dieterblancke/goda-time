...
import org.goda.time.FieldType;
...
public class DateTimeFormatterBuilder {
    ...
    private List<DateTimePrinterParser> iElementPairs;
    ...
    public DateTimeFormatterBuilder() {
        super();
        iElementPairs = new ArrayList<DateTimePrinterParser>();
    }
    ...
    private DateTimeFormatterBuilder append0(DateTimePrinterParser element) {
        iFormatter = null;
...
//        }
        ...
        public int parseInto(DateTimeParserBucket bucket, String text, int position) {
            ...
            synchronized (cParseCache) {
                Map<FieldType, Object[]> innerMap = cParseCache.get(locale);
                if (innerMap == null) {
                    innerMap = new HashMap<FieldType, Object[]>();
...
//        }
    ...
    static class Composite
        ...
        Composite(List<DateTimePrinterParser> elementPairs) {
            super();

            List<DateTimePrinter> printerList = new ArrayList<DateTimePrinter>();
            List<DateTimeParser> parserList = new ArrayList<DateTimeParser>();
...
//        }
         ...
         * and parser lists.
         */
        private void decompose(List<DateTimePrinterParser> elementPairs, List<DateTimePrinter> printerList, List<DateTimeParser> parserList) {
            ...
            for (int i=0; i<size; i+=2) {
                ...
                if (element instanceof DateTimePrinter) {
                    if (element instanceof Composite) {
                        ...
                        printerList.add((DateTimePrinter)element);
                    }
                }
                ...
                if (element instanceof DateTimeParser) {
                    if (element instanceof Composite) {
                        ...
                        parserList.add((DateTimeParser)element);
                    }
                }
            }
        }
