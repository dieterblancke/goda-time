...
public class PeriodFormatterBuilder {
    ...
    private List<PeriodPrinterParser> iElementPairs;
    ...
    public void clear() {
        ...
        if (iElementPairs == null) {
            iElementPairs = new ArrayList<PeriodPrinterParser>();
        } else {
            iElementPairs.clear();
        }
        iNotPrinter = false;
    ...
    private PeriodFormatterBuilder appendSeparator(String text, String finalText,
        ...
        List<PeriodPrinterParser> pairs = iElementPairs;
        if (pairs.size() == 0) {
    ...
    //-----------------------------------------------------------------------
    private static PeriodFormatter toFormatter(List<PeriodPrinterParser> elementPairs, boolean notPrinter, boolean notParser) {
        ...
        PeriodPrinterParser[] comp = createComposite(elementPairs);
        if (notPrinter) {
    ...
    private static PeriodPrinterParser[] createComposite(List<PeriodPrinterParser> elementPairs) {
        switch (elementPairs.size()) {
            case 0:
                return new PeriodPrinterParser[] {Literal.EMPTY, Literal.EMPTY};
            case 1:
                return new PeriodPrinterParser[] {elementPairs.get(0), elementPairs.get(1)};
            default:
    ...
    static class Separator
        ...
        Separator(String text, String finalText, String[] variants,
            ...
            if ((finalText == null || text.equals(finalText)) &&
                ...
                Set<String> parsedSet = new TreeSet<String>(String.CASE_INSENSITIVE_ORDER);
                parsedSet.add(text);
                ...
                List<String> parsedList = new ArrayList<String>(parsedSet);
...
//        }
    ...
    static class Composite
        ...
        Composite(List<PeriodPrinterParser> elementPairs) {
            List<PeriodPrinter> printerList = new ArrayList<PeriodPrinter>();
            List<PeriodParser> parserList = new ArrayList<PeriodParser>();
...
//        }
        ...
        private void decompose(List<PeriodPrinterParser> elementPairs, List<PeriodPrinter> printerList, List<PeriodParser> parserList) {
            int size = elementPairs.size();
        ...
        private <T> void addArrayToList(List<T> list, T[] array) {
            if (array != null) {
